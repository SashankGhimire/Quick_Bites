                    ...
                    <div className="w-full relative">
                        <div className="text-center py-6">
                            <h3 className="text-2xl md:text-3xl font-extrabold text-slate-800 uppercase tracking-wider flex items-center justify-center gap-3">
                                <svg className="w-6 h-6 text-slate-800" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                            ...
                            <p className="mt-2 text-sm text-slate-500">Find us at Labin Mall — open daily for dine-in & takeout.</p>
                        </div>
