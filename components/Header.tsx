  ...
  return (
    <header className="bg-white/90 backdrop-blur-md shadow-lg sticky top-0 z-50 border-b border-slate-200">
      <nav className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="hidden md:flex items-center space-x-2">
              {isAuthenticated ? (
                <>
                  <Link
                    to="/profile"
                    className="relative flex items-center p-2 text-slate-600 hover:text-primary-600 transition-colors rounded-full hover:bg-slate-100"
                ...
                <>
                  <Link
                    to="/login"
                    className="px-4 py-2 text-sm font-semibold bg-primary-500 text-white rounded-full hover:bg-primary-600 transition-colors"
                  >
                    Login
                  </Link>
                  <Link
                    to="/signup"
                    className="ml-2 px-4 py-2 text-sm font-semibold bg-orange-500 text-white rounded-full hover:bg-orange-600 transition-colors"
                  >
                    Sign Up
                  </Link>
                </>
        ...
        <div
          className={`transition-all duration-300 ease-in-out md:hidden overflow-hidden ${isMobileMenuOpen ? "max-h-96 py-4" : "max-h-0"}`}
        >
