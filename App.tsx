                                        ...
                                        <div>
                                            <h3 className="font-semibold mb-4 tracking-wider text-primary-400">Follow Us</h3>
                                                <div className="flex items-center space-x-4">
                                                    <a href="#" className="text-slate-400 hover:text-primary-400 flex items-center" aria-label="X (Twitter)">
                                                        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M22 5.92c-.63.28-1.3.48-2 .56a3.48 3.48 0 0 0 1.53-1.92 6.92 6.92 0 0 1-2.2.84 3.46 3.46 0 0 0-5.9 3.15A9.83 9.83 0 0 1 3.1 4.9a3.46 3.46 0 0 0 1.07 4.62 3.43 3.43 0 0 1-1.57-.43v.04a3.46 3.46 0 0 0 2.77 3.39c-.45.12-.92.18-1.4.07a3.46 3.46 0 0 0 3.23 2.4A6.94 6.94 0 0 1 2 18.57 9.8 9.8 0 0 0 7.29 20c6.03 0 9.33-5 9.33-9.33v-.43c.64-.46 1.2-1.05 1.64-1.72-.57.25-1.18.42-1.82.5z"/></svg>
                                                    </a>
                                                    <a href="#" className="text-slate-400 hover:text-primary-400" aria-label="Facebook">
                                                    ...
                                                    <a href="#" className="text-slate-400 hover:text-primary-400" aria-label="Instagram">
                                                        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.85s-.011 3.585-.069 4.85c-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07s-3.585-.012-4.85-.07c-3.252-.149-4.771-1.664-4.919-4.919-.058-1.265-.07-1.645-.07-4.85s.012-3.585.07-4.85c.148-3.227 1.664-4.771 4.919-4.919.058-1.266.069-1.645.069-4.85zm0 1.441c-3.17 0-3.543.012-4.78.069-2.734.125-3.958 1.348-4.083 4.083-.057 1.237-.069 1.612-.069 4.78s.012 3.543.069 4.78c.125 2.734 1.348 3.958 4.083 4.083 1.237.057 1.612.069 4.78.069s3.543-.012 4.78-.069c2.734-.125 3.958-1.348 4.083-4.083.057-1.237.069-1.612.069-4.78s-.012-3.543-.069-4.78c-.125-2.734-1.348-3.958-4.083-4.083-1.237-.057-1.612-.069-4.78-.069zm0 6.162c-2.303 0-4.162 1.86-4.162 4.162s1.86 4.162 4.162 4.162 4.162-1.86 4.162-4.162-1.859-4.162-4.162-4.162zm0 6.882c-1.503 0-2.72-1.217-2.72-2.72s1.217-2.72 2.72-2.72 2.72 1.217 2.72 2.72-1.217 2.72-2.72 2.72zm4.78-7.858c-.615 0-1.115.5-1.115 1.115s.5 1.115 1.115 1.115c.615 0 1.115-.5 1.115-1.115s-.5-1.115-1.115-1.115z"/></svg>
                                                    </a>
                                                    <a href="#" className="text-slate-400 hover:text-primary-400" aria-label="YouTube">
                                                    ...
                                                    <a href="#" className="text-slate-400 hover:text-primary-400" aria-label="LinkedIn">
                                                        <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.94v5.666H9.351V9h3.415v1.561h.049c.476-.9 1.637-1.852 3.37-1.852 3.603 0 4.269 2.37 4.269 5.456v6.287zM5.337 7.433a2.065 2.065 0 1 1 .001-4.13 2.065 2.065 0 0 1-.001 4.13zM7.119 20.452H3.554V9h3.565v11.452z"/></svg>
                                                    </a>
                                                </div>
                                        </div>
                                    </div>
