...
const menuData: FoodItem[] = [
  ...
  { id: 5, name: 'Four Cheese Pizza', description: 'Mozzarella, cheddar, parmesan and gorgonzola.', price: 17.49, category: 'Pizzas', imageUrl: 'https://kitchenatics.com/wp-content/uploads/2020/09/Cheese-pizza-1.jpg' },
  ...
  { id: 10, name: 'Double Cheeseburger', description: 'Two beef patties with double cheese and pickles.', price: 12.99, category: 'Burgers', imageUrl: 'https://www.shutterstock.com/image-photo/double-patty-burger-marbled-beef-600nw-2144739373.jpg' },
  { id: 11, name: 'Veggie Burger', description: 'Plant-based patty with fresh greens and avocado.', price: 10.99, category: 'Burgers', imageUrl: 'https://www.realsimple.com/thmb/z3cQCYXTyDQS9ddsqqlTVE8fnpc=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/real-simple-mushroom-black-bean-burgers-recipe-0c365277d4294e6db2daa3353d6ff605.jpg' },
  ...
  { id: 18, name: 'Lasagna', description: 'Layered pasta with beef ragu and béchamel sauce.', price: 15.99, category: 'Pasta', imageUrl: 'https://assets.bonappetit.com/photos/656f48d75b552734225041ba/4:3/w_4172,h_3129,c_limit/20231120-WEB-Lasanga-6422.jpg' },
  { id: 19, name: 'Mac and Cheese', description: 'Creamy baked macaroni and cheese with cheddar.', price: 11.50, category: 'Pasta', imageUrl: 'https://www.allrecipes.com/thmb/CanMXBeN-9DZyRSzDxLAoy0w-t8=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/238691-Simple-Macaroni-And-Cheese-mfs_006-f7f521c65f894aef85e17bc9125c2c4a.jpg' },
  ...
  { id: 22, name: 'Onion Rings', description: 'Crispy beer-battered onion rings.', price: 4.49, category: 'Sides', imageUrl: 'https://www.recipeworkbook.com/wp-content/uploads/2021/09/onion-rings3.jpg' },
  ...
  { id: 25, name: 'Tiramisu', description: 'Classic Italian coffee-flavored dessert.', price: 6.49, category: 'Desserts', imageUrl: 'https://www.kingarthurbaking.com/sites/default/files/2023-03/Tiramisu_1426.jpg' },
  { id: 26, name: 'Apple Pie', description: 'Warm apple pie with cinnamon and flaky crust.', price: 4.99, category: 'Desserts', imageUrl: 'https://www.southernliving.com/thmb/bbDY1d_ySIrCFcq8WNBkR-3x6pU=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/2589601_Mailb_Mailbox_Apple_Pie_003-da802ff7a8984b2fa9aa0535997ab246.jpg' },
  ...
  { id: 31, name: 'Iced Coffee', description: 'Cold-brewed coffee served over ice.', price: 2.99, category: 'Drinks', imageUrl: 'https://www.gerbes.com/content/v2/binary/image/vanilla.png' },
  { id: 32, name: 'Mango Smoothie', description: 'Creamy mango smoothie with yogurt.', price: 3.99, category: 'Drinks', imageUrl: 'https://cdn.loveandlemons.com/wp-content/uploads/2023/05/mango-smoothie.jpg' },
];
